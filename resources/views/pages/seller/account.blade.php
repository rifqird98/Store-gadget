            ...
            <div class="dashboard-content">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form id="locations" action="{{ route('dashboard.update', Auth::user()->id) }}" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="address_one"
                                                    name="address_one" value="{{ Auth::user()->address_one }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="address_two"
                                                    name="address_two" value="{{ Auth::user()->address_two }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
