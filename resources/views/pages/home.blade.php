            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="popular_categories_content">
                        ...
                        <div class="popular_categories_link"><a href="{{ route('category') }}">full catalog</></a>
                        </div>
                    </div>
                </div>
                            ...
                            @foreach ($categories as $item)
                                <div class="owl-item">
                                    ...
                                    <div
                                        ...
                                        <div class="popular_category_image"><img src="{{ Storage::url($item->photo) }}"
                                                alt=""></div>
                                        <div class="popular_category_text"><a
                                                href="{{ route('categories-detail', $item->slug) }}"
                                                class="nav-link">{{ $item->name }}</a></div>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                                            ...
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div class="product_content">
                                                        <div class="product_price">IDR{{ $item->price }}</div>
                                ...
                                <div class="col-lg-4 col-md-6 fill_height">
                                    <div class="banner_2_content">
                                        ...
                                        <div class="banner_2_text">Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit. Maecenas fermentum laoreet.</div>
